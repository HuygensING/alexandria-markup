...
import static nl.knaw.huygens.alexandria.creole.Constructors.concur;
import nl.knaw.huygens.alexandria.creole.Pattern;

public class Concur extends PatternWithTwoPatternParameters {
  ...
  public Pattern startTagDeriv(Basics.QName qn, Basics.Id id) {
    ...
    //             (concur d1 d2)
    Pattern d1 = pattern1.startTagDeriv(qn, id);
    Pattern d2 = pattern2.startTagDeriv(qn, id);
    return choice(//
        choice(//
            concur(d1, pattern2),//
            concur(pattern1, d2)//
  ...
  public Pattern endTagDeriv(Basics.QName qn, Basics.Id id) {
    ...
    //                     (concur p1 d2))
    //             (concur d1 d2)
    Pattern d1 = pattern1.endTagDeriv(qn, id);
    Pattern d2 = pattern2.endTagDeriv(qn, id);
    return choice(//
        choice(//
            concur(d1, pattern2),//
            concur(pattern1, d2)//

...
public class SnarkTest extends AlexandriaBaseStoreTest {
  ...
  public void testSnark81Master() throws LMNLSyntaxError {
    String input =
        "[poem [title}The Hunting of the Snark (An Agony in 8 Fits){title] [voice}Narrator{voice]}\n"
    ...
    runInStoreTransaction(
        store -> {
          ...
          Set<String> linguisticMarkup =
              new HashSet<>(asList("text", "phr", "phr=a", "phr=b", "word", "s", "m", "c", "w"));

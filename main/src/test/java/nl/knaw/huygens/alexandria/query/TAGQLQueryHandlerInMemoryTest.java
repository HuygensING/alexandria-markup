...
public class TAGQLQueryHandlerInMemoryTest {
  ...
  public void testTAGQLQuery1() throws LMNLSyntaxError {
    String lmnl = "[excerpt}[p}\n"//
        ...
        + "{p]{excerpt]";
    Document alice = new LMNLImporterInMemory().importLMNL(lmnl);
  ...
  public void testTAGQLQuery3() throws LMNLSyntaxError {
    ...
    Document kings = new LMNLImporterInMemory().importLMNL(lmnl);
  ...
  public void testLuminescentQuery1() throws IOException, LMNLSyntaxError {
    ...
    Document frankenstein = new LMNLImporterInMemory().importLMNL(lmnl);
  ...
  public void testTAGQLQueryWithSyntaxError() throws LMNLSyntaxError {
    String lmnl = "[text}\n"//
        ...
        + "[l}line 3{l]\n"//
        + "{text]";
    Document doc = new LMNLImporterInMemory().importLMNL(lmnl);

...
public class MarkupDiffTest extends AlexandriaBaseStoreTest {
  ...
  public void testMarkupDeletion() {
    String originText = DUMMY_HEADER + "[TAGML>A simple [del>short<del] text<TAGML]\n";
    String editedText = DUMMY_HEADER + "[TAGML>A simple text<TAGML]\n";
    List<String> markupInfoDiffs = getMarkupDiffs(originText, editedText);
  ...
  public void testMarkupAddition() {
    String originText = DUMMY_HEADER + "[TAGML>A simple text<TAGML]\n";
    String editedText = DUMMY_HEADER + "[TAGML>A simple [add>short<add] text<TAGML]\n";
    List<String> markupInfoDiffs = getMarkupDiffs(originText, editedText);
  ...
  public void testMarkupReplacement() {
    String originText = DUMMY_HEADER + "[TAGML>A [a>simple<a] text<TAGML]\n";
    String editedText = DUMMY_HEADER + "[TAGML>A [b>simple<b] text<TAGML]\n";
    List<String> markupInfoDiffs = getMarkupDiffs(originText, editedText);
  ...
  public void testMarkupSplit() {
    String originText = DUMMY_HEADER + "[TAGML>[l>Sentence one. Sentence two.<l]<TAGML]\n";
    String editedText = DUMMY_HEADER + "[TAGML>[l>Sentence one.<l][l>Sentence two.<l]<TAGML]\n";
    List<String> markupInfoDiffs = getMarkupDiffs(originText, editedText);
  ...
  public void testMarkupJoin() {
    String originText = DUMMY_HEADER + "[TAGML>[l>Sentence one.<l][l>Sentence two.<l]<TAGML]\n";
    String editedText = DUMMY_HEADER + "[TAGML>[l>Sentence one. Sentence two.<l]<TAGML]\n";
    List<String> markupInfoDiffs = getMarkupDiffs(originText, editedText);

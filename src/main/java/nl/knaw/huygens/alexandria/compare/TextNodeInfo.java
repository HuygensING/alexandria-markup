...
public class TextNodeInfo {
  ...
  public List<MarkupInfo> getMarkupInfoList() {
    return markupInfoList;
  }

  public void setMarkupInfoList(List<MarkupInfo> markupInfoList) {
    this.markupInfoList = markupInfoList;
  }

  public void addMarkupInfo(MarkupInfo markupInfo) {
    this.markupInfoList.add(markupInfo);
  }

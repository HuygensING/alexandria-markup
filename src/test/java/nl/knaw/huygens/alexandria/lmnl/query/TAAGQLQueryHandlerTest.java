...
public class TAAGQLQueryHandlerTest {
  ...
  public void testTAAGQLQuery1() {
    ...
    TAAGQLQueryHandler h = new TAAGQLQueryHandler(alice);
    ...
    TAAGQLResult result = h.execute(statement);
  ...
  public void testTAAGQLQuery2() {
    ...
    TAAGQLResult result2 = h.execute(statement2);
    ...
    TAAGQLResult result3 = h.execute(statement3);
  ...
  public void testTAAGQLQuery3() {
    ...
    TAAGQLQueryHandler h = new TAAGQLQueryHandler(kings);

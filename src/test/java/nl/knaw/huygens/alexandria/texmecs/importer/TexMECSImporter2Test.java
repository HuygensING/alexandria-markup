...
public class TexMECSImporter2Test extends AlexandriaBaseStoreTest {
  ...
  private DocumentWrapper testTexMECS(String texMECS, String expectedLMNL) {
    ...
    TexMECSImporter2 importer = new TexMECSImporter2(store);
    DocumentWrapper doc = importer.importTexMECS(texMECS);
    LMNLExporter2 ex = new LMNLExporter2(store);
